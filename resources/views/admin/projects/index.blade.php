...
<div class="table-responsive mt-5">
                ...
                <tr>
                    ...
                    <td class="d-flex">
                        ...
                        <form class="mx-2" action="{{route("project.edit", [$project->id])}}">
                            ...
                            <button class="bg-success mb-3 border-0 p-1 rounded" type="submit">Update</button>
                        </form>
    ...
    <form class="mx-2" action="{{route("project.create")}}">
        ...
        <button class="bg-success mb-3 border-0p-1 rounded" type="submit">Add new project</button>
    </form>
</div>
@endsection